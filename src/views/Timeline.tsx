...
My <span className="inline-block text-gradient">Timeline</span> </h1>
                ...
                <div className="relative z-10">
                  <div className="flex flex-col md:flex-row md:items-start gap-4">
                    ...
                    >
                      ...
                      <div
                        className="absolute left-0 md:left-1/2 transform md:-translate-x-1/2 -translate-x-20 w-16 h-16 bg-gradient-to-br glass border-4 border-white flex items-center justify-center rounded-full shadow-lg"
                        style={{
                          backgroundImage:
